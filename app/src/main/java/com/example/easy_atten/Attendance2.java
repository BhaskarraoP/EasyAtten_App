...
public class Attendance2 extends AppCompatActivity implements StudentAdapter.Itemclicked {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit=findViewById(R.id.submit_atten);
        cancel=findViewById(R.id.delete_atten);
                    ...
                    try {
                        ...
                        for (DataSnapshot child : children) {
                            ...
                            if(std.getSubjects().get(Integer.parseInt(pos))!=-1) {
                                stdinfo.add(std);
//                            Toast.makeText(Attendance2.this, stdinfo.size() + "", Toast.LENGTH_SHORT).show();
                ...
                private void fn(String pos)
                {
                    ...
                    StudentAdapter mba=new StudentAdapter(Attendance2.this,stdinfo);
                    recyclerView.setAdapter(mba);
                }
